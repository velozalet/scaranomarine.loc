	...
	<div id="primary" class="site_content service">
		<div id="content" role="main">
			...
			<div class="info_block nav_service">
				<a href="<?php echo get_the_permalink(23); ?>" id="nse_1"><i class="icons"></i>Repairs</a>
				<a href="<?php echo get_the_permalink(25); ?>" id="nse_2" class="active"><i class="icons"></i>Maintenance</a>
			</div>
			...
			<div class="info_block padB70">
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<img src="<?php echo s_get_meta_data($post->ID, 'bottom_image'); ?>" alt="" />
						</div>
					</div>
				</div>
			</div>
			
			<?php $addition_text = s_get_meta_data($post->ID, 'addition_text'); ?>
			<?php if($addition_text){ ?>
			<div class="info_block padB70">
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
